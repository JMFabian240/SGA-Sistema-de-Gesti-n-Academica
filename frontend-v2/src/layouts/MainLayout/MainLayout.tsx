...
export function MainLayout() {
  ...
  return (
    <div className="flex h-screen bg-[#f8fafc]">
      {/* Sidebar */}
      <aside className="w-64 bg-[#001429] text-slate-300 flex flex-col transition-all duration-300 relative z-20 shadow-xl">
        {/* Logo Section */}
        <div className="p-6 pb-2 border-b border-slate-700/50 flex flex-col items-center justify-center">
          <div className="w-16 h-16 bg-white rounded-2xl p-2 mb-3 shadow-sm flex items-center justify-center overflow-hidden">
            <img src="/escudo.png" alt="SGA Logo" className="w-full h-full object-contain" />
          </div>
          <h1 className="text-white font-bold text-lg tracking-wide">Colegio San Diego</h1>
          <p className="text-xs text-slate-400 mt-1 uppercase tracking-wider font-semibold">SGA</p>
        </div>
        ...
        {/* User Footer (Esquina Inferior Izquierda) */}
